...
class AudioProviderLoader {
  ...
  async load() {
    ...
    return new (await import('./vidstack-McSMJSS1.js')).AudioProvider(this.target);
  }
}
...
class VideoProviderLoader {
  ...
  async load(ctx) {
    ...
    return new (await import('./vidstack-qYLOCal4.js')).VideoProvider(this.target, ctx);
  }
}
...
class YouTubeProviderLoader {
  ...
  async load(ctx) {
    ...
    return new (await import('./vidstack-x171W0Tn.js')).YouTubeProvider(this.target);
  }
}
...
const _HLSProviderLoader = class _HLSProviderLoader extends VideoProviderLoader {
  ...
  async load(context) {
    ...
    return new (await import('./vidstack-O5RAcSDm.js')).HLSProvider(this.target, context);
  }
};
...
class VimeoProviderLoader {
  ...
  async load(ctx) {
    ...
    return new (await import('./vidstack--A88_8o5.js')).VimeoProvider(this.target);
  }
}
