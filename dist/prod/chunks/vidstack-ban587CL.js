...
import { d as createScope, s as signal, e as effect, f as isString, g as isObject, c as isNumber, h as isBoolean } from './vidstack-8AXyyPGc.js';
import { T as TimeRange, p as preconnect } from './vidstack-UzM8r9FW.js';
...
const _YouTubeProvider = class _YouTubeProvider extends EmbedProvider {
  ...
  jd({ info }, event) {
    if (!info)
      return;
    const { title, intrinsicDuration: duration, playbackRate } = this.b.$state;
