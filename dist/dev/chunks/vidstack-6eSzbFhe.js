...
class AudioProviderLoader {
  ...
  async load() {
    ...
    return new (await import('./vidstack-frLylVYd.js')).AudioProvider(this.target);
  }
}
...
class VideoProviderLoader {
  ...
  async load(ctx) {
    ...
    return new (await import('./vidstack-RZgIoVwm.js')).VideoProvider(this.target, ctx);
  }
}
...
class YouTubeProviderLoader {
  ...
  async load(ctx) {
    ...
    return new (await import('./vidstack-RD5KuqhG.js')).YouTubeProvider(this.target);
  }
}
...
const _HLSProviderLoader = class _HLSProviderLoader extends VideoProviderLoader {
  ...
  async load(context) {
    ...
    return new (await import('./vidstack-H_JoF5Bt.js')).HLSProvider(this.target, context);
  }
};
...
class VimeoProviderLoader {
  ...
  async load(ctx) {
    ...
    return new (await import('./vidstack-uILw3FJn.js')).VimeoProvider(this.target);
  }
}
