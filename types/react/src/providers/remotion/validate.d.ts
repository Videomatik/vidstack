...
export declare function validateRemotionResource({ src, compositionWidth: width, compositionHeight: height, fps, durationInFrames, initialFrame, inFrame, outFrame, numberOfSharedAudioTags, }: RemotionMediaResource): void;
...
export declare function validateComponent(src: RemotionMediaResource['src']): void;
