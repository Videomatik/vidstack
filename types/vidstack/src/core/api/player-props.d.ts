...
export type PlayerSrc = MediaResource | {
    src: MediaResource;
    type?: string;
} | {
    src: MediaResource;
...
export interface MediaPlayerProps extends Pick<MediaState, 'autoplay' | 'controls' | 'currentTime' | 'loop' | 'muted' | 'paused' | 'playsinline' | 'poster' | 'preload' | 'playbackRate' | 'viewType' | 'volume' | 'title' | 'streamType' | 'liveEdgeTolerance' | 'minLiveDVRWindow'> {
    /**
